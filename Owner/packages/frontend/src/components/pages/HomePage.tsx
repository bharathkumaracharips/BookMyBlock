                    ...
                    <div className="text-center py-20">
                        <div className="max-w-4xl mx-auto">
                            ...
                            <div className="grid md:grid-cols-3 gap-6 mb-12">
                                <Link to="/dashboard" className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-6 hover:bg-slate-800/70 transition-all duration-200 cursor-pointer group block">
                                    ...
                                    <h3 className="text-lg font-semibold text-white mb-2">Theater Management</h3>
