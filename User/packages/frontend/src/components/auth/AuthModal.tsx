          ...
          <div className="px-6 pt-6">
            <div className="flex space-x-1 bg-slate-800 rounded-lg p-1">
              <button
                ...
                className={`flex-1 px-3 py-2 text-sm font-medium rounded-md transition-all duration-200 ${activeTab === 'email'
              ...
              <button
                ...
                className={`flex-1 px-3 py-2 text-sm font-medium rounded-md transition-all duration-200 ${activeTab === 'phone'
                  ? 'bg-violet-600 text-white shadow-lg'
                  : 'text-slate-400 hover:text-white hover:bg-slate-700'
                  }`}
              >
              ...
              <button
                ...
                className={`flex-1 px-3 py-2 text-sm font-medium rounded-md transition-all duration-200 ${activeTab === 'social'
                  ? 'bg-violet-600 text-white shadow-lg'
                  : 'text-slate-400 hover:text-white hover:bg-slate-700'
                  }`}
              >
